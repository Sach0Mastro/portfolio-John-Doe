      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col-md-4">
            ...
            <div className="mt-3">
              <a href="https://github.com/Sach0Mastro" target="_blank" rel="noopener nofollow" className="text-white me-3 fs-4 footer-icon">
                <i className="bi bi-github"></i>
              </a>
              <a href="#" target="_blank" rel="noopener nofollow" className="text-white me-3 fs-4 footer-icon">
                <i className="bi bi-twitter-x"></i>
              </a>
             <a href="#" target="_blank" rel="noopener nofollow" className="text-white fs-4 footer-icon">
          ...
          <div className="col-md-4">
            <h4 className="h5">Liens utiles</h4>
          ...
          <div className="col-md-4">
            <h4 className="h5">Mes dernières réalisations</h4>
            <ul className="list-unstyled">
